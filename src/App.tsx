      ...
      <header className="relative z-10 p-6 md:p-8">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <svg className="w-7 h-7 text-white group-hover:text-orange-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-7 h-7 text-white group-hover:text-indigo-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
