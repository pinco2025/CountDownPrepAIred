const Contact = () => {
    ...
    <a href="mailto:support@prepaired.io" className="w-full md:w-1/3">
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-lg dark:shadow-2xl dark:shadow-black/20 transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="mt-2 text-text-secondary-light dark:text-text-secondary-dark">support@prepaired.io</p>
                        </div>
    </a>
                </div>
            </div>
